...
The Presenton SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Presenton
```
...
using var client = new PresentonClient(
    apiKey: Environment.GetEnvironmentVariable("PRESENTON_API_KEY")!);
