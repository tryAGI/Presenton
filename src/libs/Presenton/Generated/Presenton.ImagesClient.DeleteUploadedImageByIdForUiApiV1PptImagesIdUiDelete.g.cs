...
namespace Presenton
{
    public partial class ImagesClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteSecurityRequirement0,
            };
        partial void PrepareDeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareDeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessDeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Delete Uploaded Image By Id For Ui
        /// </summary>
        /// <param name="id"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteAsync(
            string id,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse> DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteAsResponseAsync(
            string id,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteSecurityRequirements,
                operationName: "DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDelete",
                                methodName: "DeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteAsync",
                                pathTemplate: "$\"/api/v1/ppt/images/{id}/ui\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteUploadedImageByIdForUiApiV1PptImagesIdUiDeleteResponse(
                    httpClient: HttpClient,
