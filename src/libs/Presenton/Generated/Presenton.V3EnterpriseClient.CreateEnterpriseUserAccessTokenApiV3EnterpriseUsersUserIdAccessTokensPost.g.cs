...
namespace Presenton
{
    public partial class V3EnterpriseClient
    {
        ...
        {
            var __response = await CreateEnterpriseUserAccessTokenApiV3EnterpriseUsersUserIdAccessTokensPostAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.EnterpriseUserAccessTokenRead>> CreateEnterpriseUserAccessTokenApiV3EnterpriseUsersUserIdAccessTokensPostAsResponseAsync(
            global::System.Guid userId,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Presenton.EnterpriseUserAccessTokenRead.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.EnterpriseUserAccessTokenRead>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Presenton.EnterpriseUserAccessTokenRead.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
