...
namespace Presenton
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_RevokeTokenApiV1AuthTokenRevokePostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_RevokeTokenApiV1AuthTokenRevokePostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_RevokeTokenApiV1AuthTokenRevokePostSecurityRequirement0,
            };
        partial void PrepareRevokeTokenApiV1AuthTokenRevokePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.BodyRevokeTokenApiV1AuthTokenRevokePost request);
        partial void PrepareRevokeTokenApiV1AuthTokenRevokePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.BodyRevokeTokenApiV1AuthTokenRevokePost request);
        partial void ProcessRevokeTokenApiV1AuthTokenRevokePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRevokeTokenApiV1AuthTokenRevokePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> RevokeTokenApiV1AuthTokenRevokePostAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<string>> RevokeTokenApiV1AuthTokenRevokePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRevokeTokenApiV1AuthTokenRevokePostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RevokeTokenApiV1AuthTokenRevokePostSecurityRequirements,
                operationName: "RevokeTokenApiV1AuthTokenRevokePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRevokeTokenApiV1AuthTokenRevokePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RevokeTokenApiV1AuthTokenRevokePost",
                                methodName: "RevokeTokenApiV1AuthTokenRevokePostAsync",
                                pathTemplate: "\"/api/v1/auth/token/revoke\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRevokeTokenApiV1AuthTokenRevokePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRevokeTokenApiV1AuthTokenRevokePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> RevokeTokenApiV1AuthTokenRevokePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.BodyRevokeTokenApiV1AuthTokenRevokePost
            {
                Token = token,
            };

            return await RevokeTokenApiV1AuthTokenRevokePostAsync(
                request: __request,
                requestOptions: requestOptions,
