...
namespace Presenton
{
    public partial class DebugClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_CheckCreditBalanceApiV1DebugCheckCreditBalancePostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_CheckCreditBalanceApiV1DebugCheckCreditBalancePostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_CheckCreditBalanceApiV1DebugCheckCreditBalancePostSecurityRequirement0,
            };
        partial void PrepareCheckCreditBalanceApiV1DebugCheckCreditBalancePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.BodyCheckCreditBalanceApiV1DebugCheckCreditBalancePost request);
        partial void PrepareCheckCreditBalanceApiV1DebugCheckCreditBalancePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.BodyCheckCreditBalanceApiV1DebugCheckCreditBalancePost request);
        partial void ProcessCheckCreditBalanceApiV1DebugCheckCreditBalancePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckCreditBalanceApiV1DebugCheckCreditBalancePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.CheckCreditBalanceResponse> CheckCreditBalanceApiV1DebugCheckCreditBalancePostAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.CheckCreditBalanceResponse>> CheckCreditBalanceApiV1DebugCheckCreditBalancePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCheckCreditBalanceApiV1DebugCheckCreditBalancePostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CheckCreditBalanceApiV1DebugCheckCreditBalancePostSecurityRequirements,
                operationName: "CheckCreditBalanceApiV1DebugCheckCreditBalancePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCheckCreditBalanceApiV1DebugCheckCreditBalancePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CheckCreditBalanceApiV1DebugCheckCreditBalancePost",
                                methodName: "CheckCreditBalanceApiV1DebugCheckCreditBalancePostAsync",
                                pathTemplate: "\"/api/v1/debug/check-credit-balance\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCheckCreditBalanceApiV1DebugCheckCreditBalancePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCheckCreditBalanceApiV1DebugCheckCreditBalancePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.CheckCreditBalanceResponse>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.CheckCreditBalanceResponse> CheckCreditBalanceApiV1DebugCheckCreditBalancePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.BodyCheckCreditBalanceApiV1DebugCheckCreditBalancePost
            {
                Token = token,
                User = user,
            };

            return await CheckCreditBalanceApiV1DebugCheckCreditBalancePostAsync(
                request: __request,
                requestOptions: requestOptions,
