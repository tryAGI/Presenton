...
namespace Presenton
{
    public partial class BillingClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.ModifySubscriptionResponse>> ModifySubscriptionApiV1BillingSubscriptionModifyPostAsResponseAsync(
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.ModifySubscriptionResponse>(
                                        statusCode: __response.StatusCode,
