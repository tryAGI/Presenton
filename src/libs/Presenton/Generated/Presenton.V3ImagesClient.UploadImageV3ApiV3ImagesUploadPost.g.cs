...
namespace Presenton
{
    public partial class V3ImagesClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_UploadImageV3ApiV3ImagesUploadPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_UploadImageV3ApiV3ImagesUploadPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_UploadImageV3ApiV3ImagesUploadPostSecurityRequirement0,
            };
        ...
        partial void PrepareUploadImageV3ApiV3ImagesUploadPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.BodyUploadImageV3ApiV3ImagesUploadPost request);
        partial void ProcessUploadImageV3ApiV3ImagesUploadPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUploadImageV3ApiV3ImagesUploadPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.ImageAsset> UploadImageV3ApiV3ImagesUploadPostAsync(

            global::Presenton.BodyUploadImageV3ApiV3ImagesUploadPost request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UploadImageV3ApiV3ImagesUploadPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.ImageAsset>> UploadImageV3ApiV3ImagesUploadPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUploadImageV3ApiV3ImagesUploadPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UploadImageV3ApiV3ImagesUploadPostSecurityRequirements,
                operationName: "UploadImageV3ApiV3ImagesUploadPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUploadImageV3ApiV3ImagesUploadPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UploadImageV3ApiV3ImagesUploadPost",
                                methodName: "UploadImageV3ApiV3ImagesUploadPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUploadImageV3ApiV3ImagesUploadPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUploadImageV3ApiV3ImagesUploadPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.ImageAsset> UploadImageV3ApiV3ImagesUploadPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.BodyUploadImageV3ApiV3ImagesUploadPost
            {
                File = file,
                Filename = filename,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Presenton.BodyUploadImageV3ApiV3ImagesUploadPost
            {
