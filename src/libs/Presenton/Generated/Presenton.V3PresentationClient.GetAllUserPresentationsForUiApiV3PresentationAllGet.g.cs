...
namespace Presenton
{
    public partial class V3PresentationClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_GetAllUserPresentationsForUiApiV3PresentationAllGetSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_GetAllUserPresentationsForUiApiV3PresentationAllGetSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_GetAllUserPresentationsForUiApiV3PresentationAllGetSecurityRequirement0,
            };
        partial void PrepareGetAllUserPresentationsForUiApiV3PresentationAllGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? page,
            ref int? pageSize);
        partial void PrepareGetAllUserPresentationsForUiApiV3PresentationAllGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? page,
            int? pageSize);
        partial void ProcessGetAllUserPresentationsForUiApiV3PresentationAllGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAllUserPresentationsForUiApiV3PresentationAllGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get All User Presentations For Ui<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.PaginatedResponse> GetAllUserPresentationsForUiApiV3PresentationAllGetAsync(
            int? page = default,
            int? pageSize = default,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAllUserPresentationsForUiApiV3PresentationAllGetAsResponseAsync(
                page: page,
                pageSize: pageSize,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.PaginatedResponse>> GetAllUserPresentationsForUiApiV3PresentationAllGetAsResponseAsync(
            int? page = default,
            int? pageSize = default,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAllUserPresentationsForUiApiV3PresentationAllGetArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAllUserPresentationsForUiApiV3PresentationAllGetSecurityRequirements,
                operationName: "GetAllUserPresentationsForUiApiV3PresentationAllGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAllUserPresentationsForUiApiV3PresentationAllGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAllUserPresentationsForUiApiV3PresentationAllGet",
                                methodName: "GetAllUserPresentationsForUiApiV3PresentationAllGetAsync",
                                pathTemplate: "\"/api/v3/presentation/all\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAllUserPresentationsForUiApiV3PresentationAllGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAllUserPresentationsForUiApiV3PresentationAllGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
