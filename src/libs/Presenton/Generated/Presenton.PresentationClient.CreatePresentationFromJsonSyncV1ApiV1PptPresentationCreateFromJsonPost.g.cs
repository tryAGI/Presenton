...
namespace Presenton
{
    public partial class PresentationClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostSecurityRequirement0,
            };
        partial void PrepareCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.CreatePresentationFromJsonRequestV1 request);
        partial void PrepareCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.CreatePresentationFromJsonRequestV1 request);
        partial void ProcessCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Create Presentation From Json Sync V1<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.PresentationPathAndEditPath> CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostAsync(

            global::Presenton.CreatePresentationFromJsonRequestV1 request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.PresentationPathAndEditPath>> CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostSecurityRequirements,
                operationName: "CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Presenton.PathBuilder(
                                path: "/api/v1/ppt/presentation/create/from-json",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPost",
                                methodName: "CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostAsync",
                                pathTemplate: "\"/api/v1/ppt/presentation/create/from-json\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.PresentationPathAndEditPath>(
                                        statusCode: __response.StatusCode,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreatePresentationFromJsonSyncV1ApiV1PptPresentationCreateFromJsonPostAsync(
                request: __request,
                requestOptions: requestOptions,
