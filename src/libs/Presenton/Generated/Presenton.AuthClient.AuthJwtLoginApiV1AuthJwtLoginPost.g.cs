...
namespace Presenton
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_AuthJwtLoginApiV1AuthJwtLoginPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_AuthJwtLoginApiV1AuthJwtLoginPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_AuthJwtLoginApiV1AuthJwtLoginPostSecurityRequirement0,
            };
        partial void PrepareAuthJwtLoginApiV1AuthJwtLoginPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.BodyAuthJwtLoginApiV1AuthJwtLoginPost request);
        partial void PrepareAuthJwtLoginApiV1AuthJwtLoginPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.BodyAuthJwtLoginApiV1AuthJwtLoginPost request);
        partial void ProcessAuthJwtLoginApiV1AuthJwtLoginPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthJwtLoginApiV1AuthJwtLoginPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAuthJwtLoginApiV1AuthJwtLoginPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthJwtLoginApiV1AuthJwtLoginPostSecurityRequirements,
                operationName: "AuthJwtLoginApiV1AuthJwtLoginPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthJwtLoginApiV1AuthJwtLoginPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthJwtLoginApiV1AuthJwtLoginPost",
                                methodName: "AuthJwtLoginApiV1AuthJwtLoginPostAsync",
                                pathTemplate: "\"/api/v1/auth/jwt/login\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthJwtLoginApiV1AuthJwtLoginPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthJwtLoginApiV1AuthJwtLoginPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.BearerResponse> AuthJwtLoginApiV1AuthJwtLoginPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.BodyAuthJwtLoginApiV1AuthJwtLoginPost
            {
                GrantType = grantType,
                Username = username,
                Password = password,
            ...
            return await AuthJwtLoginApiV1AuthJwtLoginPostAsync(
                request: __request,
                requestOptions: requestOptions,
