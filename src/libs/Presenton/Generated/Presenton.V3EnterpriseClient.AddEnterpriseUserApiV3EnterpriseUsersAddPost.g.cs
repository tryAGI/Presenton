...
namespace Presenton
{
    public partial class V3EnterpriseClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_AddEnterpriseUserApiV3EnterpriseUsersAddPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_AddEnterpriseUserApiV3EnterpriseUsersAddPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_AddEnterpriseUserApiV3EnterpriseUsersAddPostSecurityRequirement0,
            };
        partial void PrepareAddEnterpriseUserApiV3EnterpriseUsersAddPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.EnterpriseUserAddRequest request);
        partial void PrepareAddEnterpriseUserApiV3EnterpriseUsersAddPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.EnterpriseUserAddRequest request);
        partial void ProcessAddEnterpriseUserApiV3EnterpriseUsersAddPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddEnterpriseUserApiV3EnterpriseUsersAddPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.UserRead> AddEnterpriseUserApiV3EnterpriseUsersAddPostAsync(

            global::Presenton.EnterpriseUserAddRequest request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AddEnterpriseUserApiV3EnterpriseUsersAddPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.UserRead>> AddEnterpriseUserApiV3EnterpriseUsersAddPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAddEnterpriseUserApiV3EnterpriseUsersAddPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddEnterpriseUserApiV3EnterpriseUsersAddPostSecurityRequirements,
                operationName: "AddEnterpriseUserApiV3EnterpriseUsersAddPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Presenton.PathBuilder(
                                path: "/api/v3/enterprise/users/add",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAddEnterpriseUserApiV3EnterpriseUsersAddPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AddEnterpriseUserApiV3EnterpriseUsersAddPost",
                                methodName: "AddEnterpriseUserApiV3EnterpriseUsersAddPostAsync",
                                pathTemplate: "\"/api/v3/enterprise/users/add\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddEnterpriseUserApiV3EnterpriseUsersAddPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddEnterpriseUserApiV3EnterpriseUsersAddPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.UserRead>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.UserRead> AddEnterpriseUserApiV3EnterpriseUsersAddPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.EnterpriseUserAddRequest
            {
            ...
            return await AddEnterpriseUserApiV3EnterpriseUsersAddPostAsync(
                request: __request,
                requestOptions: requestOptions,
