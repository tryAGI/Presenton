...
namespace Presenton
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Presenton.AutoSDKRetryOptions Retry { get; set; } = new global::Presenton.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Presenton.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Presenton.IAutoSDKHook>();
        ...
        public global::Presenton.AutoSDKClientOptions AddHook(
            global::Presenton.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Presenton.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Presenton.AutoSDKClientOptions UseAuthorizationProvider(
            global::Presenton.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Presenton.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Presenton.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Presenton.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Presenton.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Presenton.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Presenton.AutoSDKHook
    {
        /// <inheritdoc />
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Presenton.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Presenton.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Presenton.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Presenton.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Presenton.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Presenton.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Presenton.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Presenton.AutoSDKClientOptions clientOptions,
            global::Presenton.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Presenton.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Presenton.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Presenton.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Presenton.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Presenton.IAutoSDKHook, global::Presenton.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Presenton.AutoSDKHookContext context)
        {
