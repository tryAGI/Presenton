...
namespace Presenton
{
    public partial class CreditClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_GetCreditAccountApiV1CreditAccountGetSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_GetCreditAccountApiV1CreditAccountGetSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_GetCreditAccountApiV1CreditAccountGetSecurityRequirement0,
            };
        partial void PrepareGetCreditAccountApiV1CreditAccountGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetCreditAccountApiV1CreditAccountGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetCreditAccountApiV1CreditAccountGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCreditAccountApiV1CreditAccountGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.CreditAccount> GetCreditAccountApiV1CreditAccountGetAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.CreditAccount>> GetCreditAccountApiV1CreditAccountGetAsResponseAsync(
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCreditAccountApiV1CreditAccountGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetCreditAccountApiV1CreditAccountGetSecurityRequirements,
                operationName: "GetCreditAccountApiV1CreditAccountGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetCreditAccountApiV1CreditAccountGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetCreditAccountApiV1CreditAccountGet",
                                methodName: "GetCreditAccountApiV1CreditAccountGetAsync",
                                pathTemplate: "\"/api/v1/credit/account\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetCreditAccountApiV1CreditAccountGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCreditAccountApiV1CreditAccountGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.CreditAccount>(
