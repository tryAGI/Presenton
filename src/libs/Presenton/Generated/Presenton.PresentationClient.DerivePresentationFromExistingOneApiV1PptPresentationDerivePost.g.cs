...
namespace Presenton
{
    public partial class PresentationClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_DerivePresentationFromExistingOneApiV1PptPresentationDerivePostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_DerivePresentationFromExistingOneApiV1PptPresentationDerivePostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_DerivePresentationFromExistingOneApiV1PptPresentationDerivePostSecurityRequirement0,
            };
        partial void PrepareDerivePresentationFromExistingOneApiV1PptPresentationDerivePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.EditPresentationRequest request);
        partial void PrepareDerivePresentationFromExistingOneApiV1PptPresentationDerivePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.EditPresentationRequest request);
        partial void ProcessDerivePresentationFromExistingOneApiV1PptPresentationDerivePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDerivePresentationFromExistingOneApiV1PptPresentationDerivePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.PresentationPathAndEditPath> DerivePresentationFromExistingOneApiV1PptPresentationDerivePostAsync(

            global::Presenton.EditPresentationRequest request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DerivePresentationFromExistingOneApiV1PptPresentationDerivePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.PresentationPathAndEditPath>> DerivePresentationFromExistingOneApiV1PptPresentationDerivePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDerivePresentationFromExistingOneApiV1PptPresentationDerivePostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DerivePresentationFromExistingOneApiV1PptPresentationDerivePostSecurityRequirements,
                operationName: "DerivePresentationFromExistingOneApiV1PptPresentationDerivePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDerivePresentationFromExistingOneApiV1PptPresentationDerivePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DerivePresentationFromExistingOneApiV1PptPresentationDerivePost",
                                methodName: "DerivePresentationFromExistingOneApiV1PptPresentationDerivePostAsync",
                                pathTemplate: "\"/api/v1/ppt/presentation/derive\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDerivePresentationFromExistingOneApiV1PptPresentationDerivePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDerivePresentationFromExistingOneApiV1PptPresentationDerivePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.PresentationPathAndEditPath> DerivePresentationFromExistingOneApiV1PptPresentationDerivePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.EditPresentationRequest
            {
            ...
            return await DerivePresentationFromExistingOneApiV1PptPresentationDerivePostAsync(
                request: __request,
                requestOptions: requestOptions,
