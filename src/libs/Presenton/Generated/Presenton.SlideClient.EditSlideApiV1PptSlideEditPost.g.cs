...
namespace Presenton
{
    public partial class SlideClient
    {


        private static readonly global::Presenton.EndPointSecurityRequirement s_EditSlideApiV1PptSlideEditPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_EditSlideApiV1PptSlideEditPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_EditSlideApiV1PptSlideEditPostSecurityRequirement0,
            };
        partial void PrepareEditSlideApiV1PptSlideEditPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.EditSlideRequest request);
        partial void PrepareEditSlideApiV1PptSlideEditPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.EditSlideRequest request);
        partial void ProcessEditSlideApiV1PptSlideEditPostResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.AnyOf<global::Presenton.PresentationPathAndEditPath, global::Presenton.SlideModel>> EditSlideApiV1PptSlideEditPostAsync(

            global::Presenton.EditSlideRequest request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EditSlideApiV1PptSlideEditPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.AnyOf<global::Presenton.PresentationPathAndEditPath, global::Presenton.SlideModel>>> EditSlideApiV1PptSlideEditPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditSlideApiV1PptSlideEditPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditSlideApiV1PptSlideEditPostSecurityRequirements,
                operationName: "EditSlideApiV1PptSlideEditPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditSlideApiV1PptSlideEditPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EditSlideApiV1PptSlideEditPost",
                                methodName: "EditSlideApiV1PptSlideEditPostAsync",
                                pathTemplate: "\"/api/v1/ppt/slide/edit\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditSlideApiV1PptSlideEditPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditSlideApiV1PptSlideEditPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Presenton.AnyOf<global::Presenton.PresentationPathAndEditPath, global::Presenton.SlideModel>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.AnyOf<global::Presenton.PresentationPathAndEditPath, global::Presenton.SlideModel>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Presenton.AnyOf<global::Presenton.PresentationPathAndEditPath, global::Presenton.SlideModel>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.AnyOf<global::Presenton.PresentationPathAndEditPath, global::Presenton.SlideModel>> EditSlideApiV1PptSlideEditPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.EditSlideRequest
            {
                Id = id,
            ...
            return await EditSlideApiV1PptSlideEditPostAsync(
                request: __request,
                requestOptions: requestOptions,
