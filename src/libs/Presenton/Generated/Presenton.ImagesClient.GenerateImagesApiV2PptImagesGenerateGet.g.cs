...
namespace Presenton
{
    public partial class ImagesClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_GenerateImagesApiV2PptImagesGenerateGetSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_GenerateImagesApiV2PptImagesGenerateGetSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_GenerateImagesApiV2PptImagesGenerateGetSecurityRequirement0,
            };
        partial void PrepareGenerateImagesApiV2PptImagesGenerateGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string prompt,
            ref global::Presenton.GenerateImagesApiV2PptImagesGenerateGetImageType? imageType,
            ref int? count);
        partial void PrepareGenerateImagesApiV2PptImagesGenerateGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string prompt,
            global::Presenton.GenerateImagesApiV2PptImagesGenerateGetImageType? imageType,
            int? count);
        partial void ProcessGenerateImagesApiV2PptImagesGenerateGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateImagesApiV2PptImagesGenerateGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GenerateImagesApiV2PptImagesGenerateGetAsync(
            string prompt,
        ...
        {
            var __response = await GenerateImagesApiV2PptImagesGenerateGetAsResponseAsync(
                prompt: prompt,
                imageType: imageType,
                count: count,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<string>> GenerateImagesApiV2PptImagesGenerateGetAsResponseAsync(
            string prompt,
            global::Presenton.GenerateImagesApiV2PptImagesGenerateGetImageType? imageType = default,
            int? count = default,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateImagesApiV2PptImagesGenerateGetArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateImagesApiV2PptImagesGenerateGetSecurityRequirements,
                operationName: "GenerateImagesApiV2PptImagesGenerateGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Presenton.PathBuilder(
                                path: "/api/v2/ppt/images/generate",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddRequiredParameter("prompt", prompt)
                                .AddOptionalParameter("image_type", imageType?.ToValueString())
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateImagesApiV2PptImagesGenerateGet",
                                methodName: "GenerateImagesApiV2PptImagesGenerateGetAsync",
                                pathTemplate: "\"/api/v2/ppt/images/generate\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateImagesApiV2PptImagesGenerateGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateImagesApiV2PptImagesGenerateGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
