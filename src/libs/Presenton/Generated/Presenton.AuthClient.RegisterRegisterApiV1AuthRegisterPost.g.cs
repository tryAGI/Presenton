...
namespace Presenton
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_RegisterRegisterApiV1AuthRegisterPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_RegisterRegisterApiV1AuthRegisterPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_RegisterRegisterApiV1AuthRegisterPostSecurityRequirement0,
            };
        partial void PrepareRegisterRegisterApiV1AuthRegisterPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.UserCreate request);
        partial void PrepareRegisterRegisterApiV1AuthRegisterPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.UserCreate request);
        partial void ProcessRegisterRegisterApiV1AuthRegisterPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRegisterRegisterApiV1AuthRegisterPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.UserRead> RegisterRegisterApiV1AuthRegisterPostAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.UserRead>> RegisterRegisterApiV1AuthRegisterPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRegisterRegisterApiV1AuthRegisterPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RegisterRegisterApiV1AuthRegisterPostSecurityRequirements,
                operationName: "RegisterRegisterApiV1AuthRegisterPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRegisterRegisterApiV1AuthRegisterPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RegisterRegisterApiV1AuthRegisterPost",
                                methodName: "RegisterRegisterApiV1AuthRegisterPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRegisterRegisterApiV1AuthRegisterPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRegisterRegisterApiV1AuthRegisterPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.UserRead> RegisterRegisterApiV1AuthRegisterPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.UserCreate
            {
                Email = email,
                Password = password,
                IsActive = isActive,
            ...
            return await RegisterRegisterApiV1AuthRegisterPostAsync(
                request: __request,
                requestOptions: requestOptions,
