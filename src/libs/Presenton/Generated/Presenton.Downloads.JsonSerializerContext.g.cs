...
namespace Presenton
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(int?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::Presenton.Device?), TypeInfoPropertyName = "NullableDevice2")]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::Presenton.DownloadFormat?), TypeInfoPropertyName = "NullableDownloadFormat2")]
    ...
    internal sealed partial class DownloadsSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class DownloadsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static DownloadsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private DownloadsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            ...
            {
                return
                    typeToConvert == typeof(global::Presenton.Device)

                    || typeToConvert == typeof(global::Presenton.Device?)

                    || typeToConvert == typeof(global::Presenton.DownloadFormat)
            ...
            {
                if (typeToConvert == typeof(global::Presenton.Device))
                {
                    return new global::Presenton.JsonConverters.DeviceJsonConverter();
                }

                if (typeToConvert == typeof(global::Presenton.Device?))
                {
                    return new global::Presenton.JsonConverters.DeviceNullableJsonConverter();
                }

                if (typeToConvert == typeof(global::Presenton.DownloadFormat))
                {
                    return new global::Presenton.JsonConverters.DownloadFormatJsonConverter();
                }

                if (typeToConvert == typeof(global::Presenton.DownloadFormat?))
                {
                    return new global::Presenton.JsonConverters.DownloadFormatNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new DownloadsSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
