...
namespace Presenton
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_CreateTokenApiV1AuthTokenCreatePostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_CreateTokenApiV1AuthTokenCreatePostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_CreateTokenApiV1AuthTokenCreatePostSecurityRequirement0,
            };
        partial void PrepareCreateTokenApiV1AuthTokenCreatePostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareCreateTokenApiV1AuthTokenCreatePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessCreateTokenApiV1AuthTokenCreatePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTokenApiV1AuthTokenCreatePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.AccessToken> CreateTokenApiV1AuthTokenCreatePostAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.AccessToken>> CreateTokenApiV1AuthTokenCreatePostAsResponseAsync(
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTokenApiV1AuthTokenCreatePostArguments(
                httpClient: HttpClient);


            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CreateTokenApiV1AuthTokenCreatePostSecurityRequirements,
                operationName: "CreateTokenApiV1AuthTokenCreatePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTokenApiV1AuthTokenCreatePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTokenApiV1AuthTokenCreatePost",
                                methodName: "CreateTokenApiV1AuthTokenCreatePostAsync",
                                pathTemplate: "\"/api/v1/auth/token/create\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTokenApiV1AuthTokenCreatePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTokenApiV1AuthTokenCreatePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.AccessToken>(
