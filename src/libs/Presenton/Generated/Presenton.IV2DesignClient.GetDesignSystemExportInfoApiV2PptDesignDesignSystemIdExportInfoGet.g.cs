...
namespace Presenton
{
    public partial interface IV2DesignClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.DesignSystemExportInfo>> GetDesignSystemExportInfoApiV2PptDesignDesignSystemIdExportInfoGetAsResponseAsync(
            global::System.Guid designSystemId,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
