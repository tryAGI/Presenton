...
namespace Presenton
{
    public partial class DebugClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_AddSubscriptionApiV1DebugAddSubscriptionPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_AddSubscriptionApiV1DebugAddSubscriptionPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_AddSubscriptionApiV1DebugAddSubscriptionPostSecurityRequirement0,
            };
        partial void PrepareAddSubscriptionApiV1DebugAddSubscriptionPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.BodyAddSubscriptionApiV1DebugAddSubscriptionPost request);
        partial void PrepareAddSubscriptionApiV1DebugAddSubscriptionPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.BodyAddSubscriptionApiV1DebugAddSubscriptionPost request);
        partial void ProcessAddSubscriptionApiV1DebugAddSubscriptionPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddSubscriptionApiV1DebugAddSubscriptionPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.Subscription> AddSubscriptionApiV1DebugAddSubscriptionPostAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.Subscription>> AddSubscriptionApiV1DebugAddSubscriptionPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAddSubscriptionApiV1DebugAddSubscriptionPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddSubscriptionApiV1DebugAddSubscriptionPostSecurityRequirements,
                operationName: "AddSubscriptionApiV1DebugAddSubscriptionPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAddSubscriptionApiV1DebugAddSubscriptionPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AddSubscriptionApiV1DebugAddSubscriptionPost",
                                methodName: "AddSubscriptionApiV1DebugAddSubscriptionPostAsync",
                                pathTemplate: "\"/api/v1/debug/add-subscription\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddSubscriptionApiV1DebugAddSubscriptionPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddSubscriptionApiV1DebugAddSubscriptionPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.Subscription>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.Subscription> AddSubscriptionApiV1DebugAddSubscriptionPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.BodyAddSubscriptionApiV1DebugAddSubscriptionPost
            {
                Token = token,
                User = user,
            ...
            return await AddSubscriptionApiV1DebugAddSubscriptionPostAsync(
                request: __request,
                requestOptions: requestOptions,
