...
namespace Presenton
{
    public partial interface IV3EnterpriseClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.EnterpriseUsersResponse>> ListEnterpriseUsersApiV3EnterpriseUsersGetAsResponseAsync(
            string enterprise,
            int? page = default,
            int? pageSize = default,
            string? search = default,
