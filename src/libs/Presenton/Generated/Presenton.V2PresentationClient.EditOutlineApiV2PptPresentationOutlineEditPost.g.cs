...
namespace Presenton
{
    public partial class V2PresentationClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_EditOutlineApiV2PptPresentationOutlineEditPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_EditOutlineApiV2PptPresentationOutlineEditPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_EditOutlineApiV2PptPresentationOutlineEditPostSecurityRequirement0,
            };
        partial void PrepareEditOutlineApiV2PptPresentationOutlineEditPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.EditOutlineRequestV2 request);
        partial void PrepareEditOutlineApiV2PptPresentationOutlineEditPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.EditOutlineRequestV2 request);
        partial void ProcessEditOutlineApiV2PptPresentationOutlineEditPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditOutlineApiV2PptPresentationOutlineEditPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> EditOutlineApiV2PptPresentationOutlineEditPostAsync(

            global::Presenton.EditOutlineRequestV2 request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EditOutlineApiV2PptPresentationOutlineEditPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<string>> EditOutlineApiV2PptPresentationOutlineEditPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditOutlineApiV2PptPresentationOutlineEditPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditOutlineApiV2PptPresentationOutlineEditPostSecurityRequirements,
                operationName: "EditOutlineApiV2PptPresentationOutlineEditPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Presenton.PathBuilder(
                                path: "/api/v2/ppt/presentation/outline/edit",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditOutlineApiV2PptPresentationOutlineEditPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EditOutlineApiV2PptPresentationOutlineEditPost",
                                methodName: "EditOutlineApiV2PptPresentationOutlineEditPostAsync",
                                pathTemplate: "\"/api/v2/ppt/presentation/outline/edit\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditOutlineApiV2PptPresentationOutlineEditPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditOutlineApiV2PptPresentationOutlineEditPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> EditOutlineApiV2PptPresentationOutlineEditPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.EditOutlineRequestV2
            {
                PresentationId = presentationId,
                Outlines = outlines,
            };

            return await EditOutlineApiV2PptPresentationOutlineEditPostAsync(
                request: __request,
                requestOptions: requestOptions,
