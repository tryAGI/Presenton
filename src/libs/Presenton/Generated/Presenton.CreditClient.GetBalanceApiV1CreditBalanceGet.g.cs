...
namespace Presenton
{
    public partial class CreditClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_GetBalanceApiV1CreditBalanceGetSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_GetBalanceApiV1CreditBalanceGetSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_GetBalanceApiV1CreditBalanceGetSecurityRequirement0,
            };
        partial void PrepareGetBalanceApiV1CreditBalanceGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetBalanceApiV1CreditBalanceGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetBalanceApiV1CreditBalanceGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetBalanceApiV1CreditBalanceGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.CreditAccountWithBalance> GetBalanceApiV1CreditBalanceGetAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.CreditAccountWithBalance>> GetBalanceApiV1CreditBalanceGetAsResponseAsync(
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetBalanceApiV1CreditBalanceGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetBalanceApiV1CreditBalanceGetSecurityRequirements,
                operationName: "GetBalanceApiV1CreditBalanceGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetBalanceApiV1CreditBalanceGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetBalanceApiV1CreditBalanceGet",
                                methodName: "GetBalanceApiV1CreditBalanceGetAsync",
                                pathTemplate: "\"/api/v1/credit/balance\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBalanceApiV1CreditBalanceGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBalanceApiV1CreditBalanceGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.CreditAccountWithBalance>(
