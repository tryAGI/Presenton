...
namespace Presenton
{
    public partial class V3PresentationClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostSecurityRequirement0,
            };
        partial void PrepareCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.CreatePresentationFromJsonRequestV3 request);
        partial void PrepareCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.CreatePresentationFromJsonRequestV3 request);
        partial void ProcessCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.PresentationPathAndEditPath> CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostAsync(

            global::Presenton.CreatePresentationFromJsonRequestV3 request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.PresentationPathAndEditPath>> CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostSecurityRequirements,
                operationName: "CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPost",
                                methodName: "CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostAsync",
                                pathTemplate: "\"/api/v3/presentation/from-json\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreatePresentationFromJsonSyncV3ApiV3PresentationFromJsonPostAsync(
                request: __request,
                requestOptions: requestOptions,
