...
namespace Presenton
{
    public partial class V3SchemaClient
    {


        private static readonly global::Presenton.EndPointSecurityRequirement s_GenerateContentForSchemaApiV3SchemaContentGeneratePostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_GenerateContentForSchemaApiV3SchemaContentGeneratePostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_GenerateContentForSchemaApiV3SchemaContentGeneratePostSecurityRequirement0,
            };
        ...
        partial void ProcessGenerateContentForSchemaApiV3SchemaContentGeneratePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GenerateContentForSchemaApiV3SchemaContentGeneratePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateContentForSchemaApiV3SchemaContentGeneratePostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateContentForSchemaApiV3SchemaContentGeneratePostSecurityRequirements,
                operationName: "GenerateContentForSchemaApiV3SchemaContentGeneratePostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Presenton.PathBuilder(
                                path: "/api/v3/schema/content/generate",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateContentForSchemaApiV3SchemaContentGeneratePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateContentForSchemaApiV3SchemaContentGeneratePost",
                                methodName: "GenerateContentForSchemaApiV3SchemaContentGeneratePostAsync",
                                pathTemplate: "\"/api/v3/schema/content/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateContentForSchemaApiV3SchemaContentGeneratePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateContentForSchemaApiV3SchemaContentGeneratePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Presenton.GenerateContentForSchemaResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.GenerateContentForSchemaResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Presenton.GenerateContentForSchemaResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateContentForSchemaApiV3SchemaContentGeneratePostAsync(
                request: __request,
                requestOptions: requestOptions,
