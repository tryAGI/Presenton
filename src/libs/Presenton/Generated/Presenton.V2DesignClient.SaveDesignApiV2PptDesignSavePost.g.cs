...
namespace Presenton
{
    public partial class V2DesignClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_SaveDesignApiV2PptDesignSavePostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_SaveDesignApiV2PptDesignSavePostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_SaveDesignApiV2PptDesignSavePostSecurityRequirement0,
            };
        partial void PrepareSaveDesignApiV2PptDesignSavePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.SaveDesignRequest request);
        partial void PrepareSaveDesignApiV2PptDesignSavePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.SaveDesignRequest request);
        partial void ProcessSaveDesignApiV2PptDesignSavePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSaveDesignApiV2PptDesignSavePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.SaveDesignResponse> SaveDesignApiV2PptDesignSavePostAsync(

            global::Presenton.SaveDesignRequest request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SaveDesignApiV2PptDesignSavePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.SaveDesignResponse>> SaveDesignApiV2PptDesignSavePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSaveDesignApiV2PptDesignSavePostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SaveDesignApiV2PptDesignSavePostSecurityRequirements,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSaveDesignApiV2PptDesignSavePostRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SaveDesignApiV2PptDesignSavePost",
                                methodName: "SaveDesignApiV2PptDesignSavePostAsync",
                                pathTemplate: "\"/api/v2/ppt/design/save\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSaveDesignApiV2PptDesignSavePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Presenton.SaveDesignResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.SaveDesignResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Presenton.SaveDesignResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.SaveDesignResponse> SaveDesignApiV2PptDesignSavePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.SaveDesignRequest
            {
                DesignId = designId,
            ...
            return await SaveDesignApiV2PptDesignSavePostAsync(
                request: __request,
                requestOptions: requestOptions,
