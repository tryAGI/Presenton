...
namespace Presenton
{
    public partial interface IV3EnterpriseClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.EnterpriseUsersInfoResponse>> GetEnterpriseUsersInfoApiV3EnterpriseUsersInfoGetAsResponseAsync(
            string enterprise,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
