...
namespace Presenton
{
    public partial class V2OnClient
    {


        private static readonly global::Presenton.EndPointSecurityRequirement s_PresentationExportApiV2OnPresentationExportPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_PresentationExportApiV2OnPresentationExportPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_PresentationExportApiV2OnPresentationExportPostSecurityRequirement0,
            };
        partial void PreparePresentationExportApiV2OnPresentationExportPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.BodyPresentationExportApiV2OnPresentationExportPost request);
        partial void PreparePresentationExportApiV2OnPresentationExportPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.BodyPresentationExportApiV2OnPresentationExportPost request);
        partial void ProcessPresentationExportApiV2OnPresentationExportPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPresentationExportApiV2OnPresentationExportPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> PresentationExportApiV2OnPresentationExportPostAsync(

            global::Presenton.BodyPresentationExportApiV2OnPresentationExportPost request,
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PresentationExportApiV2OnPresentationExportPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<string>> PresentationExportApiV2OnPresentationExportPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePresentationExportApiV2OnPresentationExportPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PresentationExportApiV2OnPresentationExportPostSecurityRequirements,
                operationName: "PresentationExportApiV2OnPresentationExportPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Presenton.PathBuilder(
                                path: "/api/v2/on/presentation/export",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePresentationExportApiV2OnPresentationExportPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PresentationExportApiV2OnPresentationExportPost",
                                methodName: "PresentationExportApiV2OnPresentationExportPostAsync",
                                pathTemplate: "\"/api/v2/on/presentation/export\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPresentationExportApiV2OnPresentationExportPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPresentationExportApiV2OnPresentationExportPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> PresentationExportApiV2OnPresentationExportPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.BodyPresentationExportApiV2OnPresentationExportPost
            {
            ...
            return await PresentationExportApiV2OnPresentationExportPostAsync(
                request: __request,
                requestOptions: requestOptions,
