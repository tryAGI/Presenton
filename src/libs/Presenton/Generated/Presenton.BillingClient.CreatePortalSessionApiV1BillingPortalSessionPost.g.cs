...
namespace Presenton
{
    public partial class BillingClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_CreatePortalSessionApiV1BillingPortalSessionPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_CreatePortalSessionApiV1BillingPortalSessionPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_CreatePortalSessionApiV1BillingPortalSessionPostSecurityRequirement0,
            };
        partial void PrepareCreatePortalSessionApiV1BillingPortalSessionPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Presenton.BodyCreatePortalSessionApiV1BillingPortalSessionPost request);
        partial void PrepareCreatePortalSessionApiV1BillingPortalSessionPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Presenton.BodyCreatePortalSessionApiV1BillingPortalSessionPost request);
        partial void ProcessCreatePortalSessionApiV1BillingPortalSessionPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePortalSessionApiV1BillingPortalSessionPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.CreatePortalSessionResponse> CreatePortalSessionApiV1BillingPortalSessionPostAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<global::Presenton.CreatePortalSessionResponse>> CreatePortalSessionApiV1BillingPortalSessionPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePortalSessionApiV1BillingPortalSessionPostArguments(
            ...
            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePortalSessionApiV1BillingPortalSessionPostSecurityRequirements,
                operationName: "CreatePortalSessionApiV1BillingPortalSessionPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePortalSessionApiV1BillingPortalSessionPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreatePortalSessionApiV1BillingPortalSessionPost",
                                methodName: "CreatePortalSessionApiV1BillingPortalSessionPostAsync",
                                pathTemplate: "\"/api/v1/billing/portal/session\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePortalSessionApiV1BillingPortalSessionPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePortalSessionApiV1BillingPortalSessionPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Presenton.AutoSDKHttpResponse<global::Presenton.CreatePortalSessionResponse>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::Presenton.CreatePortalSessionResponse> CreatePortalSessionApiV1BillingPortalSessionPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Presenton.BodyCreatePortalSessionApiV1BillingPortalSessionPost
            {
                ReturnUrl = returnUrl,
            };

            return await CreatePortalSessionApiV1BillingPortalSessionPostAsync(
                request: __request,
                requestOptions: requestOptions,
