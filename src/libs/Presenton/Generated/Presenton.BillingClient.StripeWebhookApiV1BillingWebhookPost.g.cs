...
namespace Presenton
{
    public partial class BillingClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_StripeWebhookApiV1BillingWebhookPostSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_StripeWebhookApiV1BillingWebhookPostSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_StripeWebhookApiV1BillingWebhookPostSecurityRequirement0,
            };
        partial void PrepareStripeWebhookApiV1BillingWebhookPostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareStripeWebhookApiV1BillingWebhookPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessStripeWebhookApiV1BillingWebhookPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStripeWebhookApiV1BillingWebhookPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> StripeWebhookApiV1BillingWebhookPostAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<string>> StripeWebhookApiV1BillingWebhookPostAsResponseAsync(
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareStripeWebhookApiV1BillingWebhookPostArguments(
                httpClient: HttpClient);


            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_StripeWebhookApiV1BillingWebhookPostSecurityRequirements,
                operationName: "StripeWebhookApiV1BillingWebhookPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareStripeWebhookApiV1BillingWebhookPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StripeWebhookApiV1BillingWebhookPost",
                                methodName: "StripeWebhookApiV1BillingWebhookPostAsync",
                                pathTemplate: "\"/api/v1/billing/webhook\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStripeWebhookApiV1BillingWebhookPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStripeWebhookApiV1BillingWebhookPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
