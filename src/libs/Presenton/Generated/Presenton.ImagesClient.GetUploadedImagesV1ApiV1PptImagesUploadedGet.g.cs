...
namespace Presenton
{
    public partial class ImagesClient
    {
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement s_GetUploadedImagesV1ApiV1PptImagesUploadedGetSecurityRequirement0 =
        ...
        private static readonly global::Presenton.EndPointSecurityRequirement[] s_GetUploadedImagesV1ApiV1PptImagesUploadedGetSecurityRequirements =
            new global::Presenton.EndPointSecurityRequirement[]
            {                s_GetUploadedImagesV1ApiV1PptImagesUploadedGetSecurityRequirement0,
            };
        partial void PrepareGetUploadedImagesV1ApiV1PptImagesUploadedGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetUploadedImagesV1ApiV1PptImagesUploadedGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetUploadedImagesV1ApiV1PptImagesUploadedGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUploadedImagesV1ApiV1PptImagesUploadedGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetUploadedImagesV1ApiV1PptImagesUploadedGetAsync(
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetUploadedImagesV1ApiV1PptImagesUploadedGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Presenton.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Presenton.AutoSDKHttpResponse<string>> GetUploadedImagesV1ApiV1PptImagesUploadedGetAsResponseAsync(
            global::Presenton.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUploadedImagesV1ApiV1PptImagesUploadedGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::Presenton.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetUploadedImagesV1ApiV1PptImagesUploadedGetSecurityRequirements,
                operationName: "GetUploadedImagesV1ApiV1PptImagesUploadedGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Presenton.PathBuilder(
                                path: "/api/v1/ppt/images/uploaded",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUploadedImagesV1ApiV1PptImagesUploadedGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Presenton.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUploadedImagesV1ApiV1PptImagesUploadedGet",
                                methodName: "GetUploadedImagesV1ApiV1PptImagesUploadedGetAsync",
                                pathTemplate: "\"/api/v1/ppt/images/uploaded\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUploadedImagesV1ApiV1PptImagesUploadedGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Presenton.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUploadedImagesV1ApiV1PptImagesUploadedGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
